...
- `public/data/` is generated by `pnpm scrape`; never hand-edit it. Test fixtures for the scraper
  live in `scripts/scrape/__fixtures__/` and are trimmed copies of real API responses.
